...
\begin{multicols}{2}
	...
	\includegraphics[width=0.5\textwidth]{./images/Saddle_Node.pdf}
\end{multicols}
...
\begin{multicols}{2}
	...
	\includegraphics[width=0.5\textwidth]{./images/superkritisch.pdf}
	\columnbreak
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\textwidth]{./images/phasenraum.pdf}
\end{figure}
